...
const NegotiationForm = ()=>{
    ...
    const getCookie = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NegotiationForm.useCallback[getCookie]": (name)=>{
            const value = `; ${document.cookie}`;
            const parts = value.split(`; ${name}=`);
            if (parts.length === 2) return parts.pop()?.split(';').shift() || null;
            return null;
        }
    }["NegotiationForm.useCallback[getCookie]"], []);
    const fetchOrderData = async ()=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to fetch order data. Please try again.");
        }
    };
    const fetchProductData = async ()=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to fetch product data. Please try again.");
        } finally{
            setLoading(false);
        }
    };
    ...
    const onSubmit = async ()=>{
        ...
        if (!orderData || !productData) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Product or order data is not available. Please refresh and try again.");
            return;
        }
        setSubmitting(true);
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Negotiation submitted successfully!");
            // Reset form
            setFormData({
                negotiationType: 'Percentage',
                negotiationValue: '',
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to submit negotiation. Please try again.");
        } finally{
            setSubmitting(false);
        }
    };
...
_s(NegotiationForm, "Pob6sNvA5Fy1cmyZhM8vlTIVsQs=", false, function() {
    return [
...
var _c;
__turbopack_context__.k.register(_c, "NegotiationForm");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_a8ed083b._.js.map