...
"[project]/app/(orders)/checkout/[id]/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const OrdersComponent = ()=>{
    ...
    const [sameAddress, setSameAddress] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const API_URL = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL || "http://localhost:3033";
    ...
    const selectedIds = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "OrdersComponent.useMemo[selectedIds]": ()=>{
    ...
    const getCookie = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "OrdersComponent.useCallback[getCookie]": (name)=>{
    ...
    }["OrdersComponent.useCallback[getCookie]"], []);
    ...
    const verifyTokenAndFetchUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "OrdersComponent.useCallback[verifyTokenAndFetchUser]": async ()=>{
            try {
                setLoading(true);
                setError(null);
                ...
                if (!tokenResponse.ok) {
                    const errorData = await tokenResponse.json().catch({
                        "OrdersComponent.useCallback[verifyTokenAndFetchUser]": ()=>({
    ...
    const fetchRequirements = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "OrdersComponent.useCallback[fetchRequirements]": async (ids)=>{
            if (ids.length === 0) {
                setRequirements([]);
                return;
            }
            try {
                ...
                const requirementPromises = ids.map({
                    "OrdersComponent.useCallback[fetchRequirements].requirementPromises": async (id)=>{
                        ...
                        if (!response.ok) {
                            const errorData = await response.json().catch({
                                "OrdersComponent.useCallback[fetchRequirements].requirementPromises": ()=>({
    ...
    }["OrdersComponent.useCallback[fetchRequirements]"], [
        getCookie,
        router,
        API_URL
    ]);
    ...
    const { subtotal, totalGST, total } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "OrdersComponent.useMemo": ()=>{
            if (requirements.length === 0) {
                return {
                    subtotal: 0,
                    totalGST: 0,
            ...
            const subtotal = requirements.reduce({
                "OrdersComponent.useMemo.subtotal": (total, req)=>{
                    const amount = Number(req.negotiationDetails.newAmount) || 0;
                    return total + amount;
                }
            }["OrdersComponent.useMemo.subtotal"], 0);
            const totalGST = requirements.reduce({
                "OrdersComponent.useMemo.totalGST": (totalGST, req)=>{
                    const amount = Number(req.negotiationDetails.newAmount) || 0;
                    const gstPercentage = Number(req.gstPercentage) || 0;
                    const gstAmount = amount * gstPercentage / 100;
                    return totalGST + gstAmount;
                }
            }["OrdersComponent.useMemo.totalGST"], 0);
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$label$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Label"], {
                                            ...
                                            children: [
                                                "Shipping Address ",
                                                !sameAddress && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "text-red-500",
                                                    children: "*"
                                                }, void 0, false, {
                                                    fileName: "[project]/app/(orders)/checkout/[id]/page.tsx",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            ...
                            requirements.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                lineNumber: 608,
                                columnNumber: 13
                            }, this) : requirements.map((req)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(OrdersComponent, "raEKXY2xKnMujqgLVbLoodwP9Gw=", false, function() {
    return [
...
var _c;
__turbopack_context__.k.register(_c, "OrdersComponent");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_78636266._.js.map