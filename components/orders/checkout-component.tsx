...
const CheckoutComponent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Main Content */}
      <div className="max-w-4xl mx-auto mt-7 bg-white shadow-lg rounded-lg overflow-hidden">
        {/* Header */}
        <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-6">
          <div className="text-center">
            <h1 className="text-2xl font-bold text-white tracking-wider">SABECHO</h1>
          </div>
        </div>
        ...
        <div className="p-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="space-y-3">
                <p className="text-gray-900 font-medium text-lg">{user?.companyName || user?.name || "N/A"}</p>
                <div className="flex items-start space-x-2">
                  <MapPin size={16} className="text-gray-500 mt-1 flex-shrink-0" />
                  <p className="text-gray-600">{billingAddress || "Mumbai"}</p>
                </div>
                <Button
                  variant="link"
                  className="text-blue-600 text-sm p-0 h-auto hover:underline font-medium"
                    ...
                    return (
                      <div key={req._id} className="space-y-2">
                        <div className="flex justify-between items-start">
                          <div>
                            <h4 className="font-medium text-gray-900">{req.productName}</h4>
                            <p className="text-sm text-gray-600">
                              Quantity: {req.minQty} {req.measurement}
                            </p>
                          </div>
                          <div className="text-right">
                            <p className="font-medium text-gray-900">₹{formatter.format(amount)}</p>
                            <p className="text-sm text-gray-600">
          ...
          <div className="mt-8 space-y-4">
            ...
            <Button
              className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-4 text-lg rounded-lg disabled:opacity-50 disabled:cursor-not-allowed"
